...
이제 쉘코드를 만들어 보내면 끝인데 `pwntools`의 `shellcraft`를 사용할 거에요.

[<U>이 사이트</U>](https://docs.pwntools.com/en/stable/)를 뒤져보면 `pwntools`의 `shellcraft` 사용법도 나와요!

- - -
# 0x02. 익스플로잇

크기는 넉넉하게 `0x100`만큼 받았어요.
